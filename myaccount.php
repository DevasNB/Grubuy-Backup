                ...
                <div class="card mb-4 style-border4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="' . $_SESSION["user_Name"] . '" disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label class="small mb-1 bold" for="inputEmailAddress">Email address: </label>
                                        <input class="form-control" id="inputEmailAddress" type="email" placeholder="' . $_SESSION["user_Email"] . '" disabled>
                                    </div>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="inputOrgName" type="text" placeholder="' . $_SESSION["user_Website"] . '" disabled>
                                        </div>
                                        <!-- Form Group (location)-->
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="inputLocation">Location: </label>
                                            <input class="form-control" id="inputLocation" type="text" placeholder="' . $_SESSION["user_Location"] . '" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="inputPhone" placeholder="' . $_SESSION["user_Phone"] . '" disabled>
                                        </div>
                                        <!-- Form Group (birthday)-->
                                        <div class="col-md-6">
